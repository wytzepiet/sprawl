...
| `economy.md` | Everything as a stock that runs down and every building as a row, labour as a good made at home, posted prices that move with stock, one protocol with money as hours, the edge as a world with the same rows and a crossing, one purse for the town moved only at the door, GDP and the treasury as two different numbers, the port as the second door, the tests that assert the equilibria. | Built through §12 step 7 and the port (§12.10): the second door on the coast, its ship and the sea's crossing, the handling classes, 2026-09-17; §12.5 to §12.10 record what the seasons and the looks found. |
| `multiplayer.md` | One world, many towns, one sea: the door as a port with a ferry and a batch, the fog as the shared survey, influence from traffic as the claim, why roads get built, coastal spawns, the port town. | Specification, 2026-09-10; nothing built. |
