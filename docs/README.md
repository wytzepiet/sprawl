...
| `economy.md` | Everything as a stock that runs down, purses, posted prices that move with stock, one protocol with money as hours, the edge as the one door, floats and the sweep to the mayor, the tests that assert the equilibria. | Built through §12 step 2, 2026-09-09; §12.2 is what building decided. |
