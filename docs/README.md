...
| `economy.md` | Purses, companies, posted prices that move with stock, one score with money as hours, the sea and the edge as the band, the mayor's two taxes, the tests that assert the equilibria. | Specification, 2026-09-09; nothing built. |
