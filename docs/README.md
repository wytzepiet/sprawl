...
| `economy.md` | Everything as a stock that runs down and every building as a row, labour as a good made at home, posted prices that move with stock, one protocol with money as hours, the edge as a world with the same rows and a crossing, one purse for the town moved only at the door, GDP and the treasury as two different numbers, the tests that assert the equilibria. | Built through §12 step 7's first cuts, the books to a season, the town's page and the price line on the card (§12.9), 2026-09-16; §12.5 to §12.9 record what the seasons found. |
